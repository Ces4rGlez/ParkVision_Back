                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="auth-form-light py-2 px-4">
                                            <h1 class="card-title text-center mb-4" style="font-family: 'Quicky Story'; color: #851C1C ;" >Crear Cuenta Cliente
                                                <hr>
                                            </h1>
                            ...
                            <div class="col-md-7">
                                <div class="card">
                                    <div class="card-body mt-3">
                                        <h1 class="text-center mb-4" style="font-family: 'Quicky Story'; color: #851C1C ;" >Lista de Clientes
                                            <hr>
                                        </h1>
