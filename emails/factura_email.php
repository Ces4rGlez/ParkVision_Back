...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Descarga de Factura - Parking';
    ...
    $mail->Body .= "<p>Para descargar tu factura, haz clic en el siguiente enlace:</p>";
    $mail->Body .= "<p><a href='https://parking.com/app/dashboard/FacturaClientePDF.php?idReserva=" . $IdReserva . "' style='background: #ff6d0c; font-size:15px; padding: 10px 20px; border-radius: 25px; text-decoration: none; color:#fff;'>Descargar Factura</a></p>";
    ...
    $mail->AltBody .= "Para descargar tu factura, visita: https://parking.com/app/dashboard/FacturaClientePDF.php?idReserva=" . $IdReserva . "\n";
